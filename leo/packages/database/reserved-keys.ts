export const SanitizeFieldNames = (FieldName: string) => {
  let Expression = FieldName // TODO: separate by "." and use "[]"
  ...
  RESERVED_KEYWORDS.forEach((keyword) => {
    ...
    match.forEach((match) => {
      ...
      Expression = Expression.replace(regexp, AttrName)
      AttrNames[AttrName] = match
    })
  })
  return { Expression, AttrNames }
}
/**
