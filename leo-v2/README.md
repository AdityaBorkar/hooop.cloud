...
- Biome:
  - "extends": ["next/core-web-vitals","eslint-plugin-react-compiler"],
  - Make a plugin that supports next-core-web-vitals and react-compiler with Biome.js
  - Import Sorting in the way I want
  - TailwindCSS Support
  - Replace next-bundle-analyzer with Biome's Analyzer
- (ESLinting Rules / Typescript Rules) for (SST/Leo) usage in Next.js
