...
export default async function ProjectInfraPage() {
  ...
  return (
    <main className='cursor-default px-[10vw]'>
      ...
      <div className='mb-6 mt-12 flex flex-row justify-between text-2xl font-semibold'>
      ...
      <div className='grid grid-cols-2 divide-x divide-y divide-neutral-600 border border-neutral-600 text-neutral-300 *:px-2 *:py-1'>
